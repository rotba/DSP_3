...
public class Main {
    ...
    public static String[] remoteMilionsInputs = {
            "s3://dsp3/ins/milions/biarcs.10-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.11-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.20-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.21-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.30-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.31-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.40-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.41-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.50-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.51-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.60-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.61-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.70-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.71-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.80-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.81-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.90-of-99.gz",
            "s3://dsp3/ins/milions/biarcs.91-of-99.gz",
    };

    public static String[] remoteAllInputs = {
            "s3://dsp3/ins/all/biarcs.10-of-99.gz",
            "s3://dsp3/ins/all/biarcs.20-of-99.gz",
            "s3://dsp3/ins/all/biarcs.30-of-99.gz",
            "s3://dsp3/ins/all/biarcs.40-of-99.gz",
            "s3://dsp3/ins/all/biarcs.50-of-99.gz",
            "s3://dsp3/ins/all/biarcs.60-of-99.gz",
    };

    public static void main(String[] args) throws Exception {
        int argsIndex = 0;
        String local = args[argsIndex++];
        String large = args[argsIndex++];
        ...
        String[] inputs = mr.common.Utils.addInputs(input, local.equals("LOCAL") ? localInputs : large.equals("LARGE") ? remoteAllInputs : remoteMilionsInputs);
